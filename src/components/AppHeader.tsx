 ...
 * Handles Android status bar height so header never overlaps system UI.
 * Color: #1e3c72 (matches company branding / Home screen).
 */
...
/** Height of Android status bar (0 on iOS — SafeAreaView handles it) */
...
export default function AppHeader({
  ...
  return (
    <>
      <StatusBar barStyle="light-content" backgroundColor={HEADER_BG} translucent={false} />
