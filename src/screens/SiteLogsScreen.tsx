...
import {
    ...
    StatusBar, FlatList, TextInput, Modal, Share,
} from 'react-native';
import { api } from '../api';
...
export default function SiteLogsScreen({ navigation }: any) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <StatusBar barStyle="light-content" backgroundColor="#233344" />

            <LinearGradient colors={['#233344', '#3a5068']} style={styles.header}>
                <TouchableOpacity onPress={() => setSidebarVisible(true)} style={styles.hBtn}>
                    <Icon name="menu" size={22} color="#fff" />
                </TouchableOpacity>
                <View style={{ alignItems: 'center', flex: 1 }}>
                    <Text style={styles.hTitle}>📊 SITE LOGS</Text>
                    <Text style={styles.hSub}>{hasLoaded ? `${totalRecords} records  ·  ${dateLabel}` : 'Apply filters to load'}</Text>
                </View>
                        ...
                        totalPages > 1 ? (
                            <View style={styles.pagination}>
                                ...
                                <TouchableOpacity
                                    ...
                                    disabled={currentPage === 1}
                                >
                                    <Icon name="chevron-left" size={14} color="#5B9BD5" />
                                </TouchableOpacity>
                                ...
                                >
                                    <Icon name="chevron-right" size={14} color="#5B9BD5" />
                                </TouchableOpacity>
                                <TouchableOpacity
                                    style={[styles.pageBtn, currentPage === totalPages && styles.pageBtnDisabled]}
...
const styles = StyleSheet.create({
    ...
    hBtn: { padding: 6 },
    hTitle: { color: '#fff', fontSize: 14, fontWeight: '800', letterSpacing: 0.5 },
