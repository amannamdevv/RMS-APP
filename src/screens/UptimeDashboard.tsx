...
import {
    ...
    ActivityIndicator, SafeAreaView, Dimensions, RefreshControl, StatusBar, Platform, Modal
} from 'react-native';
import { api } from '../api';
    ...
    const renderItem = ({ item }: { item: any }) => (
        ...
        >
            ...
            <View style={styles.rowRight}>
                ...
                {activeTab === 'circle' && <Icon name="chevron-right" size={16} color="#cbd5e1" style={{ marginLeft: 10 }} />}
            </View>
        </TouchableOpacity>
    );
        ...
        <SafeAreaView style={styles.container}>
            ...
            <LinearGradient colors={['#1e3c72', '#2a5298']} style={styles.topHeader}>
                <View style={styles.topBar}>
                    ...
                    <Text style={styles.topTitle}>Uptime & SLA Analytics</Text>
                    <View style={{ width: 24 }} />
                </View>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.kpiScroll}>
                    <View style={[styles.kpiBox, { borderTopColor: '#2ecc71' }]}>
                        <View style={styles.kpiRow}>
                           <Text style={styles.kpiTextValue}>{kpis.compliance}%</Text>
                           <Icon name="check-circle" color="#2ecc71" size={16} />
                        </View>
                        <Text style={styles.kpiTitleLabel}>SLA Compliance</Text>
                    </View>
                    <View style={[styles.kpiBox, { borderTopColor: '#3498db' }]}>
                        <View style={styles.kpiRow}>
                           <Text style={styles.kpiTextValue}>{kpis.total}</Text>
                           <Icon name="server" color="#3498db" size={16} />
                        </View>
                        <Text style={styles.kpiTitleLabel}>Total Sites</Text>
                    </View>
                    <View style={[styles.kpiBox, { borderTopColor: '#27ae60' }]}>
                        <View style={styles.kpiRow}>
                           <Text style={styles.kpiTextValue}>{kpis.met}</Text>
                           <Icon name="thumbs-up" color="#27ae60" size={16} />
                        </View>
                        <Text style={styles.kpiTitleLabel}>Sites Meeting SLA</Text>
                    </View>
                    <View style={[styles.kpiBox, { borderTopColor: '#e74c3c' }]}>
                        <View style={styles.kpiRow}>
                           <Text style={styles.kpiTextValue}>{kpis.failed}</Text>
                           <Icon name="alert-circle" color="#e74c3c" size={16} />
                        </View>
                ...
                <View>
                    ...
                    <View style={styles.filterSection}>
                        ...
                        <TouchableOpacity style={styles.applyBtnLarge} onPress={fetchDashboardData}>
                            <Icon name="filter" color="#fff" size={16} style={{ marginRight: 8 }} />
                ...
                <View style={styles.tabBarContainer}>
                    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.tabScroll}>
                        {[
                            ...
                            >
                                <Icon name={t.icon as any} size={14} color={activeTab === t.id ? '#fff' : '#64748b'} />
                    ...
                    <View style={styles.modalContent}>
                        ...
                        {['All', 'Summer', 'Monsoon', 'Winter'].map(s => (
                            <TouchableOpacity key={s} style={styles.modalOption} onPress={() => { setSeason(s); setShowSeasonModal(false); }}>
                                ...
                                {season === s && <Icon name="check" size={18} color="#1e3c72" />}
                            </TouchableOpacity>
                        ))}
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    kpiBox: { backgroundColor: '#fff', borderRadius: 10, padding: 12, marginRight: 10, width: 120, borderTopWidth: 4, elevation: 3 },
    kpiRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    kpiTextValue: { fontSize: 16, fontWeight: 'bold', color: '#1e3c72' },
    kpiTitleLabel: { fontSize: 9, color: '#64748b', marginTop: 5, textTransform: 'uppercase' },
