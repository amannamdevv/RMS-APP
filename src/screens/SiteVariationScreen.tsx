...
import {
  ...
  TextInput, Linking, Alert, Dimensions, FlatList
} from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <LinearGradient colors={['#1e3c72', '#2a5298']} style={styles.header}>
        <View style={styles.topBar}>
          ...
          <Text style={styles.headerTitle}>Site Variation Analysis</Text>
          <View style={{ width: 40 }} />
        </View>
      </LinearGradient>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row2}>
            <View style={styles.halfInput}>
              ...
              <TextInput style={styles.input} placeholder="YYYY-MM-DD" placeholderTextColor="#94a3b8" value={startDate} onChangeText={setStartDate} />
            </View>
            <View style={styles.halfInput}>
              <Text style={styles.label}>To Date</Text>
              <TextInput style={styles.input} placeholder="YYYY-MM-DD" placeholderTextColor="#94a3b8" value={endDate} onChangeText={setEndDate} />
            </View>
          </View>
          ...
          <TouchableOpacity style={styles.searchBtn} onPress={fetchData} disabled={loading}>
            {loading
              ...
              : <><Icon name="search" size={16} color="#fff" /><Text style={styles.searchBtnText}>  Analyze Site</Text></>
            }
          </TouchableOpacity>
        </View>
        ...
        {!siteData && !loading && (
          <View style={styles.emptyCard}>
            <Icon name="activity" size={52} color="#cbd5e1" />
        ...
        {siteData && (
          <>
            ...
            <View style={styles.kpiRow}>
              <KpiCard icon="truck" label="DG Events" value={`${siteData.alarm_summary.dg_events_count}`} color="#3b82f6" />
            ...
            <View style={[styles.kpiRow, { marginBottom: 0 }]}>
              <KpiCard icon="bar-chart-2" label="Avg Voltage" value={`${siteData.voltage_statistics.avg_voltage.toFixed(1)}V`} color="#0ea5e9" />
            ...
            <View style={styles.tabBar}>
              <TouchableOpacity style={[styles.tab, activeTab === 'chart' && styles.tabActive]} onPress={() => setActiveTab('chart')}>
                <Icon name="activity" size={14} color={activeTab === 'chart' ? '#1e3c72' : '#fff'} />
              ...
              <TouchableOpacity style={[styles.tab, activeTab === 'alarms' && styles.tabActive]} onPress={() => setActiveTab('alarms')}>
                <Icon name="bell" size={14} color={activeTab === 'alarms' ? '#1e3c72' : '#fff'} />
            ...
            {activeTab === 'chart' && chartData && (
              <View style={styles.card}>
                ...
                <View style={{ height: 400, backgroundColor: '#f8fafc', borderRadius: 12, overflow: 'hidden' }}>
                  <FlatList
                    data={reversedCorrelation}
                    keyExtractor={voltageKeyExtractor}
                    renderItem={renderVoltageRow}
            ...
            {activeTab === 'alarms' && (
              <View style={styles.card}>
                ...
                {alarms.length === 0
                  ...
                  : (
                    <FlatList
                      data={alarms.slice(0, 100)}
                      keyExtractor={alarmKeyExtractor}
...
const styles = StyleSheet.create({
  ...
  searchBtn: {
    ...
    padding: 13, borderRadius: 10, marginTop: 4,
  },
  ...
  emptyTitle: { fontSize: 17, fontWeight: '700', color: '#334155', marginTop: 14, marginBottom: 6 },
  emptyText: { fontSize: 13, color: '#94a3b8', textAlign: 'center', lineHeight: 20 },

  infoGrid: { gap: 8 },
  infoRow: { flexDirection: 'row', alignItems: 'center' },
  infoLabel: { width: 90, fontSize: 12, color: '#64748b', fontWeight: '600' },
  ...
  kpiVal: { fontSize: 18, fontWeight: '800', color: '#1e293b', marginBottom: 2 },
  kpiLab: { fontSize: 9, color: '#64748b', textTransform: 'uppercase', textAlign: 'center' },
