        ...
        <TouchableOpacity style={SCC.card} onPress={() => setOpen(o => !o)} activeOpacity={0.85}>
            ...
            <View style={SCC.header}>
                ...
                <View style={{ alignItems: 'flex-end', gap: 4 }}>
                    ...
                    <Icon name={open ? 'chevron-up' : 'chevron-down'} size={13} color="#94a3b8" />
                </View>
            </View>
        ...
        <SafeAreaView style={styles.container}>
            ...
            <LinearGradient colors={['#1e3c72', '#2a5298']} style={styles.header}>
                ...
                <View style={{ alignItems: 'center', flex: 1 }}>
                    <Text style={styles.hTitle}>DCEM ANALYTICS</Text>
                    <Text style={styles.hSub}>{fromDate} → {toDate}</Text>
                </View>
                    ...
                    ListHeaderComponent={
                        <View>
                            ...
                            <View style={styles.dateRow}>
                                <DateRow label="From Date" value={fromDate} onChange={setFromDate} />
                                <View style={{ width: 10 }} />
                                <DateRow label="To Date" value={toDate} onChange={setToDate} />
                                <TouchableOpacity style={styles.fetchBtn} onPress={() => fetchData()} activeOpacity={0.8}>
                            ...
                            <View style={styles.searchRow}>
                                <Icon name="search" size={14} color="#94a3b8" style={{ marginRight: 6 }} />
                                <TextInput
