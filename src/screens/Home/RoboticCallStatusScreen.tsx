    ...
    return (
      ...
      >
        <LinearGradient colors={colors} style={styles.kpiIconContainer}>
          <Icon name={icon} size={scale(20)} color="#fff" />
        </LinearGradient>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        ListFooterComponent={loading && !refreshing ? <ActivityIndicator size="small" color="#1e3c72" style={{ margin: 20 }} /> : null}
        ListEmptyComponent={!loading ? (
          <View style={styles.emptyContainer}>
            <Icon name="inbox" size={scale(40)} color="#cbd5e1" />
...
const styles = StyleSheet.create({
  ...
  emptyText: { marginTop: verticalScale(10), color: '#94a3b8', fontSize: responsiveFontSize(14) }
});
