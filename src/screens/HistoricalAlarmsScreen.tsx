                ...
                <View style={EM.box}>
                    ...
                    {[
                        ...
                        <TouchableOpacity key={o.v} style={EM.option} onPress={() => { onExport(o.v); onClose(); }}>
                            <Icon name={o.icon} size={16} color="#5B9BD5" />
        ...
        <SafeAreaView style={styles.container}>
            ...
            <LinearGradient colors={['#1e293b', '#334155']} style={styles.header}>
                ...
                <View style={{ alignItems: 'center', flex: 1 }}>
                    <Text style={styles.hTitle}>📊 HISTORICAL ALARMS</Text>
                    <Text style={styles.hSub}>{hasLoaded ? `${totalCount} alarms  ·  ${dateLabel}` : 'Apply filters to load'}</Text>
                </View>
                <View style={{ flexDirection: 'row' }}>
                    <TouchableOpacity onPress={() => setExportVisible(true)} style={styles.hBtn}>
