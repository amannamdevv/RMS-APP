        ...
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            <View style={[styles.iconBox, { backgroundColor: 'rgba(59, 130, 246, 0.1)' }]}>
              <Icon name="monitor" size={20} color="#3b82f6" />
            </View>
            <View>
            ...
            {portalTab === 'analytics' ? (
              ...
              <View style={styles.form}>
                ...
                <TouchableOpacity style={styles.fileBtn} onPress={() => handlePickImage('portal')}>
                  <Icon name="image" size={18} color="#64748b" style={{ marginRight: 8 }} />
            ...
            {fixTab === 'analytics' ? (
              ...
              <View style={styles.form}>
                ...
                <TouchableOpacity style={styles.fileBtn} onPress={() => handlePickImage('fix')}>
                  <Icon name="paperclip" size={18} color="#64748b" style={{ marginRight: 8 }} />
