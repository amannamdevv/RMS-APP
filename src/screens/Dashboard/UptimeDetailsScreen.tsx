            ...
            >
                <Animatable.View animation="fadeInUp" delay={index * 10}>
                    <View style={styles.cardHeader}>
                        ...
                        <MaterialIcon name={isExpanded ? "chevron-up" : "chevron-down"} size={18} color="#94a3b8" />
                    </View>
                            ...
                            {item.downtime_periods && item.downtime_periods.length > 0 ? (
                                <View style={styles.downtimeSection}>
                                    <View style={styles.downtimeHeader}>
                                        <MaterialIcon name="clock-alert-outline" size={14} color="#64748b" />
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View style={styles.empty}>
                            <MaterialIcon name="clipboard-text-search-outline" size={35} color="#cbd5e1" />
