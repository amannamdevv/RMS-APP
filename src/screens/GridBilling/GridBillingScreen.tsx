    ...
    const handleExport = async () => {
        ...
        try {
            ...
            const csvContent = [
                ...
                '',
                'KPI,VALUE',
                `"Overall AC Uptime","${data.kpis?.ac_uptime || 0}%"`,
                `"Total Phase Missing","${data.kpis?.phase_missing_incidents || 0}"`,
                `"Low Voltage Alerts","${data.kpis?.low_voltage_alerts || 0}"`,
                '',
                header,
                ...siteRows
            ].join('\n');
