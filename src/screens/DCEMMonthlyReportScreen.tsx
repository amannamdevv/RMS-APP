/**
 * DCEMMonthlyReportScreen.tsx
 *
 * Maps to: GET /api/dcem/monthly-report/?imei=...&year=...&month=...
 *
 * Response envelope (data.rows[]):
 * {
 *   imei, site_name, site_id, month_year, total_readings,
 *   month_start_date, month_end_date,
 *   channels: { ch1..ch4: { name, opening_kwh, closing_kwh, consumption,
 *                            avg_current, max_current, min_current, avg_load_kw } }
 *   operator1_consumption..4, start_operator1..4, end_operator1..4,
 *   independent_avg_cur1..4, independent_max_cur1..4, independent_min_cur1..4,
 *   operator1_load..4,
 *   avg_voltage, max_voltage, min_voltage,
 *   avg_temperature, max_temperature, min_temperature,
 *   avg_signal, total_consumption, peak_current,
 *   overall_avg_current, overall_max_current, overall_min_current,
 *   daily_avg_consumption
 * }
 * Top-level:
 *   total_load_consumed, total_avgCurr_all, overall_avg_voltage,
 *   overall_max_voltage, overall_min_voltage, total_avg_power_all,
 *   avg_load_per_site
 */
        ...
        <SafeAreaView style={styles.container}>
            ...
            <LinearGradient colors={['#2c3e50', '#34495e']} style={styles.header}>
                ...
                <View style={{ alignItems: 'center', flex: 1 }}>
                    <Text style={styles.hTitle}>DCEM MONTHLY REPORT</Text>
                    <Text style={styles.hSub}>{MONTHS[parseInt(month) - 1]} {year}</Text>
                </View>
            ...
            >
                    ...
                    <View style={{ paddingBottom: 30 }}>
                        <View style={styles.resultHeader}>
                            <Text style={styles.resultTitle}>
                                {data?.month_name}  ·  {rows.length} IMEI{rows.length > 1 ? 's' : ''}
                            </Text>
                ...
                {data?.status === 'success' && rows.length === 0 && (
                    <View style={{ alignItems: 'center', paddingTop: 40 }}>
                        ...
                        <Text style={{ color: '#94a3b8', fontSize: 13, marginTop: 12 }}>No data found for this period</Text>
                    </View>
                )}
            </ScrollView>
