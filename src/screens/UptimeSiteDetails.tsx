...
import {
    ...
    ActivityIndicator, SafeAreaView, Dimensions, FlatList, RefreshControl, StatusBar, TextInput, Platform
} from 'react-native';
import { api } from '../api';
            ...
            <View style={styles.filterSection}>
                ...
                <View style={styles.actionButtons}>
                    ...
                    <TouchableOpacity style={styles.resetBtn} onPress={resetDates}>
                        <Icon name="rotate-ccw" size={14} color="#1e3c72" />
...
const styles = StyleSheet.create({
    ...
    statsScroll: { marginHorizontal: -20, paddingHorizontal: 20, marginBottom: 15 },
    statPill: { 
        backgroundColor: '#fff', 
        paddingVertical: 10, 
    ...
    statVal: { fontSize: 16, fontWeight: 'bold', color: '#1e3c72' },
    statLab: { fontSize: 9, color: '#64748b', textTransform: 'uppercase', marginTop: 2 },
    
    // NEW Filter Styles
    filterSection: { backgroundColor: '#fff', padding: 15, marginHorizontal: 15, marginTop: -10, borderRadius: 15, elevation: 3 },
    datePickerRow: { flexDirection: 'row', gap: 10, marginBottom: 12 },
    dateInput: { flex: 1, backgroundColor: '#f1f5f9', padding: 8, borderRadius: 8, borderWidth: 1, borderColor: '#e2e8f0' },
    dateLabel: { fontSize: 10, color: '#64748b', textTransform: 'uppercase', marginBottom: 2 },
    dateValue: { fontSize: 13, color: '#1e3c72', fontWeight: 'bold' },
