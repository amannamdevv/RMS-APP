        ...
        <SafeAreaView style={styles.container}>
            ...
            <LinearGradient colors={['#012a4a', '#01497c']} style={styles.header}>
                ...
                <View style={{ alignItems: 'center', flex: 1 }}>
                    <Text style={styles.hTitle} numberOfLines={1}>{category}</Text>
                    <Text style={styles.hSub}>{dateLabel}</Text>
                </View>
                <TouchableOpacity onPress={handleShare} style={styles.hBtn}>
            ...
            {loading ? (
                <View style={styles.loaderBox}>
                    ...
                    <Text style={styles.loaderTxt}>Loading site details...</Text>
                </View>
            ) : error ? (
...
const styles = StyleSheet.create({
    ...
    hBtn: { padding: 6 },
    hTitle: { color: '#fff', fontSize: 13, fontWeight: '800', letterSpacing: 0.5 },
    hSub: { color: 'rgba(255,255,255,0.75)', fontSize: 9, fontWeight: '600', marginTop: 2 },

    // Stats banner — matches website "25 Sites Found"
    statsBanner: { backgroundColor: '#fff', borderRadius: 14, padding: 16, flexDirection: 'row', alignItems: 'center', marginBottom: 12, elevation: 2 },
    statItem: { flex: 1, alignItems: 'center' },
    statVal: { fontSize: 22, fontWeight: '800', color: '#01497c', marginBottom: 4 },
    statLab: { fontSize: 8, color: '#64748b', fontWeight: '800', letterSpacing: 0.5, textAlign: 'center' },
    ...
    listTitle: { fontSize: 13, fontWeight: '800', color: '#0f172a' },
    ...
    thTxt: { fontSize: 9, fontWeight: '800', color: '#fff', textAlign: 'center', letterSpacing: 0.3 },

    // Site Card
    siteCard: { backgroundColor: '#fff', borderRadius: 12, padding: 12, marginBottom: 8, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 3 },
    cardTop: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 6 },
    cardNumBox: { width: 24, height: 24, borderRadius: 12, backgroundColor: '#f1f5f9', justifyContent: 'center', alignItems: 'center' },
    cardNum: { fontSize: 10, fontWeight: '800', color: '#64748b' },
    siteName: { fontSize: 12, fontWeight: '800', color: '#0f172a', marginBottom: 2 },
    siteId: { fontSize: 9, color: '#64748b', fontFamily: 'monospace' },
    ebBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, borderWidth: 1 },
    ebBadgeTxt: { fontSize: 10, fontWeight: '800' },
    locationRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginBottom: 2 },
    locationTxt: { fontSize: 9, color: '#64748b', flex: 1 },
    ...
    totalLabel: { fontSize: 9, fontWeight: '800', color: '#64748b', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
    lastUpdRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 4 },
    lastUpdTxt: { fontSize: 9, color: '#94a3b8' },
