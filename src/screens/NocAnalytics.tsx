...
export default function NocAnalytics({ navigation }: any) {
    ...
    const filteredAlarms = useMemo(() => {
        if (severityFilter === 'all') return allAlarms;
    ...
    const renderStatCard = (
        ...
        <TouchableOpacity
            ...
            activeOpacity={0.75}
        >
            <View style={[styles.statIconRow, { backgroundColor: `${color}18` }]}>
        ...
        <SafeAreaView style={styles.container}>
            ...
            <LinearGradient colors={['#1e3c72', '#2a5298']} style={styles.header}>
                ...
                <View style={styles.headerCenter}>
                    <Text style={styles.headerTitle}>NOC ANALYTICS</Text>
...
const styles = StyleSheet.create({
    ...
    // KPI
    kpiWrapper: { backgroundColor: '#fff', paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: '#e2e8f0' },
    kpiScroll: { paddingHorizontal: 16, gap: 10 },
    statCard: {
        backgroundColor: '#f8fafc', padding: 12, borderRadius: 14,
        width: 100, alignItems: 'center', borderWidth: 1, borderColor: '#e2e8f0',
    },
    statIconRow: { width: 34, height: 34, borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginBottom: 6 },
