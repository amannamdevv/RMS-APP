...
export default function OtpScreen({ navigation, route }: Props) {
  // Correctly extracted BOTH variables inside the component!
  ...
  const handleVerify = async () => {
    ...
    try {
      // Successfully passing both arguments to the new FastAPI backend!
...
const styles = StyleSheet.create({
  flex: {flex: 1}, gradient: {flex: 1}, scrollContent: {flexGrow: 1, paddingHorizontal: 24, paddingTop: 60, paddingBottom: 40},
  ...
  logoCircle: {width: 88, height: 88, borderRadius: 44, backgroundColor: '#ffffff', justifyContent: 'center', alignItems: 'center', marginBottom: 16, elevation: 8},
  logoImage: {width: 58, height: 58}, title: {fontSize: 22, fontWeight: '800', color: '#fff', textAlign: 'center'},
  subtitle: {fontSize: 13, color: '#8a8fa8', marginTop: 6, textAlign: 'center'},
